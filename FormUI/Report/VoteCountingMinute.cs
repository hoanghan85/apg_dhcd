...
namespace pmDHCD
{
    ...
    public class VoteCountingMinute : ReportClass
    {

        public VoteCountingMinute() : base()
        {
        }
        ...
        public override string ResourceName
        {
            get
            {
                return "Report.VoteCountingMinute.rpt";
            }
            set
            {
                // Do nothing
        ...
        public override string FullResourceName
        {
            get
            {
                return "pmDHCD.Report.VoteCountingMinute.rpt";
            }
            set
            {
                // Do nothing
