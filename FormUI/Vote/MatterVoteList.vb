Public Class MatterVoteList
    ...
    Private Sub DataGridView1_CellValueChanged(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellValueChanged
        If e.RowIndex >= 0 AndAlso e.ColumnIndex >= 0 Then
            ...
            If colName = "Agree" OrElse colName = "Disagree" OrElse colName = "Noidea" Then
                Try
                    ...
                    Mainform.BenlyDal.MatterVotes_update(Mainform.workingmeeting, mattercode, delegatecode, agree, disagree, noidea)
                    filldgv()
                Catch ex As Exception
                    MsgBox("Lỗi :" + ex.Message)
                End Try
