...
namespace pmDHCD
{
    public partial class HolderListForSelectByCode
    {
        private string strHolderCode;

        public object HolderCode
        {
            get
            {
                return strHolderCode;
            }
            set
            {
                strHolderCode = Conversions.ToString(value);
            }
        }

        public HolderListForSelectByCode()
        {
            InitializeComponent();
        }
        ...
        private void filldgv()
        {
            ...
            try
            {
                dt = My.MyProject.Forms.Mainform.BenlyDal.Holder_getlist(My.MyProject.Forms.Mainform.workingmeeting, Conversions.ToString(HolderCode), "");
            }
