...
namespace pmDHCD
{
    public partial class MeetingList
    {
        ...
        private void ToolStripButton5_Click(object sender, EventArgs e)
        {
            ...
            My.MyProject.Forms.Mainform.stockCode = Conversions.ToString(DataGridView1.CurrentRow.Cells["StockCode"].Value);
            My.MyProject.Forms.Mainform.mettingType = Conversions.ToString(DataGridView1.CurrentRow.Cells["MettingType"].Value); // stockCode
            Close();
        }
